...
Organ included: `r paste(report_organs)`<br>
...
if (isChromeInstalled())
{
  ...
  # Create two widgets
  cal_this_month <- makeTciCalendar(reportStart, tciThisMonth, report_organs, TRUE, FALSE)
  cal_next_month <- makeTciCalendar(reportStart, tciNextMonth, report_organs, TRUE, FALSE)
