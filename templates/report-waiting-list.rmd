...
#logo_dest <- file.path(output_dir, basename(logo_src))
#if (file.exists(logo_src)) {
#  file.copy(logo_src, logo_dest, overwrite = TRUE)
#} else {
#  warning("Logo not found at: ", normalizePath(logo_src))
#  cat(paste("<!-- logo not available at -->",normalizePath(logo_src, mustWork = F), getwd()))
#}
if (file.exists(logo_src)) {
