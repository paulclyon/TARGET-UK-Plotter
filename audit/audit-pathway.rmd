...
refToDTTMeanPlot(referralTimes, "Month", selectedGroup = "Performed")
```


```{r dttToRxMeanPlot, echo=FALSE, warning=FALSE}
dttToRxMeanPlot(referralTimes, "Month", selectedGroup = "Performed")
```

```{r refToRxMeanPlot, echo=FALSE, warning=FALSE}
refToRxMeanPlot(referralTimes, "Month", selectedGroup = "Performed")
```
